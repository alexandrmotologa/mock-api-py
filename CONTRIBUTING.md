# Contributing to mock-api-py

Thank you for your interest in contributing to mock-api-py! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/mock-api-py.git
   cd mock-api-py
   ```
...
mock-api-py requires **Python 3.12+** and uses [`uv`](https://github.com/astral-sh/uv) (or standard `pip` / `venv`) for reproducible virtual environments.

1. **Clone the repository and set up a virtual environment:**
   ```bash
   git clone https://github.com/alexandrmotologa/mock-api-py.git
   cd mock-api-py
   uv venv
